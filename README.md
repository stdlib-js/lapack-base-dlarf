...
```javascript
dlarf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack-base-dlarf@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dlarf = require( 'path/to/vendor/umd/lapack-base-dlarf/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/lapack-base-dlarf@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/lapack-base-dlarf.svg
[npm-url]: https://npmjs.org/package/@stdlib/lapack-base-dlarf

[test-image]: https://github.com/stdlib-js/lapack-base-dlarf/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/lapack-base-dlarf/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/lapack-base-dlarf/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/lapack-base-dlarf?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/lapack-base-dlarf.svg
[dependencies-url]: https://david-dm.org/stdlib-js/lapack-base-dlarf/main
...
[deno-url]: https://github.com/stdlib-js/lapack-base-dlarf/tree/deno
[deno-readme]: https://github.com/stdlib-js/lapack-base-dlarf/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/lapack-base-dlarf/tree/umd
[umd-readme]: https://github.com/stdlib-js/lapack-base-dlarf/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/lapack-base-dlarf/tree/esm
[esm-readme]: https://github.com/stdlib-js/lapack-base-dlarf/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/lapack-base-dlarf/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/lapack-base-dlarf/main/LICENSE
