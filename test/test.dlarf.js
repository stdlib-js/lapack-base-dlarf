...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof dlarf, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 10', function test( t ) {
	t.strictEqual( dlarf.length, 10, 'returns expected value' );
	t.end();
});
...
tape( 'the function throws an error if provided a first argument which is not a valid order', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dlarf( value, 'left', 3, 3, V, 1, 1.0, C, 3, work );
		};
	}
});
...
tape( 'the function throws an error if provided a second argument which is not a valid side', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dlarf( 'row-major', value, 3, 3, V, 1, 1.0, C, 3, work );
		};
	}
});
...
tape( 'the function throws an error if provided a ninth argument which is not a valid LDC value (row-major)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dlarf( 'row-major', 'left', 3, 3, V, 1, 1.0, C, value, work );
		};
	}
});
...
tape( 'the function throws an error if provided a ninth argument which is not a valid LDC value (column-major)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dlarf( 'column-major', 'left', 4, 3, V, 1, 1.0, C, value, work );
		};
	}
});
...
tape( 'the function throws an error if provided a sixth argument which is not a valid stride', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dlarf( 'row-major', 'left', 3, 3, V, value, 1.0, C, 3, work );
		};
	}
});
...
tape( 'the function returns the array unchanged if `tau` is zero', function test( t ) {
	...
	out = dlarf( data.order, data.side, data.M, data.N, V, data.strideV, data.tau, C, data.LDC, work );
